...
const ESarthee = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="sarthee-heading-first" 
        style={{ color: color }}>
          E-Sarthee
        </div>
        ...
        <div className="sarthee-menu">
          ...
          >
             {/* sun */}
            {theme==="dark" && <div onClick={()=>ChangeThemeToLight()} >
              <svg width="26" height="26" viewBox="0 0 13 13" xmlns="http://www.w3.org/2000/svg" fill="#48ff91">
            ...
            {/* //moon */}
            {theme==="light" && <div onClick={()=>ChangeThemeToDark()}>
              <svg width="26px" height="26px" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          {isMenu && (
            <div>
              <svg
                ...
                onClick={()=>setIsMenu(!isMenu)}
              >
                <rect x="2" y="11" width="20" height="2.5" rx="1" fill={color} transform="rotate(45 12 12)" />
                <rect x="2" y="11" width="20" height="2.5" rx="1" fill={color} transform="rotate(-45 12 12)" />
      ...
      {isMenu && (
        <div className="sarthee-menu-content" style={{backgroundColor:bgColor}}>
          <div
          ...
          <div
            ...
            style={{ backgroundColor: color , color: theme==="light"? "white":"black"}}
          >
            <img
